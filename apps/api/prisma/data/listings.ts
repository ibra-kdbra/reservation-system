export const listingsData = [
  ...
  {
    title: 'Private Khmer Villa near Angkor Wat',
    description:
      'Secluded luxury villa nestled in a tropical garden, minutes from the temples of Angkor. Combines traditional Khmer architecture with modern minimalism. Features a saltwater lap pool, open-air living pavilion, and dedicated staff. Perfect sanctuary after a day of exploring ruins.',
    propertyType: 'VILLA' as const,
    status: 'PUBLISHED' as const,
    country: 'Cambodia',
    city: 'Siem Reap',
    ...
    bathrooms: 2,
    instantBook: true,
    coverImage: 'https://images.unsplash.com/photo-1590523277543-a94d2e4eb00b?auto=format&fit=crop&w=1280&q=80',
    images: [
      'https://images.unsplash.com/photo-1590523277543-a94d2e4eb00b?auto=format&fit=crop&w=1280&q=80',
      'https://images.unsplash.com/photo-1576675784201-0e142b423952?auto=format&fit=crop&w=1280&q=80',
      'https://images.unsplash.com/photo-1512918760532-85c67555300d?auto=format&fit=crop&w=1280&q=80',
    ],
    amenityNames: ['WiFi', 'Air Conditioning', 'Pool', 'Garden', 'Breakfast Included', 'Concierge Service'],
    hostIndex: 1, // Mei
  }
];
