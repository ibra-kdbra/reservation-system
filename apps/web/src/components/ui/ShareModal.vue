            ...
            <div v-if="isOpen" class="share-overlay" @click.self="close">
                <div class="share-modal">
                    <div class="share-header">
                        ...
                        <button class="share-close" @click="close">
                    ...
                    <div class="share-preview" v-if="listing">
                        <img :src="listing.coverImage" :alt="listing.title" class="share-preview-img" />
...
const props = defineProps<{
    isOpen: boolean
    listing: { title: string; coverImage: string; city: string; country: string } | null
}>()
